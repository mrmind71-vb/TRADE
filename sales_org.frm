...
Begin VB.Form salesfrm 
   ...
   Begin VB.Frame Frame15 
      ...
      Top             =   9045
      Width           =   2040
      Begin Threed.SSCommand cmdPrice 
         Height          =   420
         Left            =   90
         TabIndex        =   190
         Top             =   180
   ...
   Begin VB.Frame Frame6 
      ...
      Begin Threed.SSCommand cmdLast 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_org.frx":30D1B
         Caption         =   "«ŒÌ—"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "sales_org.frx":32EEB
      End
      Begin Threed.SSCommand cmdNext 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_org.frx":35033
         Caption         =   "·«Õﬁ "
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "sales_org.frx":371FB
      End
      Begin Threed.SSCommand cmdPrevious 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_org.frx":3934A
         Caption         =   "”«»ﬁ"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "sales_org.frx":3B52A
      End
      Begin Threed.SSCommand cmdFirst 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Picture         =   "sales_org.frx":3D685
         Caption         =   "√Ê·"
         Alignment       =   4
         PictureAlignment=   9
         PictureDisabledFrames=   1
         PictureDisabled =   "sales_org.frx":3F841
      End
   End
...
Dim oSearchPrice As New Search_empty
...
ElseIf ActiveControl.Name = xCode.Name Then
    ...
    xCode_LostFocus
    Unload oSearchCl1
ElseIf ActiveControl.Name = cmdPrice.Name Then
    
    If oSearchPrice.grid1.TextMatrix(oSearchPrice.grid1.Row, 0) <> "" Then
        If MsgBox(" €ÌÌ— «·”⁄— «·›« Ê—… «·Ì ”⁄— " & oSearchPrice.grid1.TextMatrix(oSearchPrice.grid1.Row, 1), vbDefaultButton2 + vbOKCancel) = vbOK Then
            On Error GoTo myerror
            con.Execute "UPDATE FILE6_20 SET " & _
                        " FILE6_20.PRICE = FILE1_10." & oSearchPrice.grid1.TextMatrix(oSearchPrice.grid1.Row, 0) & _
...
PriceLookup Me, oSearchPrice, , "⁄œ„  ⁄œÌ· «·”⁄—"
End Sub
...
cmdPrice.Enabled = cmdSave.Enabled
